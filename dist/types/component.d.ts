...
declare class Component {
     ...
     */
    static registerComponent<C extends Component>(name: string, ComponentToRegister: C): C;
    /**
     ...
     */
    constructor(player: import('./player').default, options?: ComponentOptions, ready?: () => any);
    player_: any;
    isDisposed_: boolean;
